               ...
               <div class="content-body px-0 py-4 px-md-4">
                  <div class="row">
                     <div class="col-12 col-lg-10 col-xl-8 col-xxl-6">
                        {/* <!-- Banner --> */}
                        <div class="banner">
                           <h4 class="">Chỉnh sửa Banner trang tuyển dụng</h4>
                           <br />
                        ...
                        <div class="job">
                           ...
                           <div class="list-job p-3 pt-1 my-4 border">
                              <div class="job-item row w-100 align-items-center mt-3 border-bottom pb-2">
                                 <div class="col-10">
                                    <h5 class="fw-medium">Designer</h5>
                                    <p class="mb-0 fs-6">
                           ...
                           <h4 class="mt-5">Thêm vị trí tuyển dụng mới</h4>
                           ...
                           <br />
                           <label for="">Hướng dẫn ứng tuyển</label>
                           <br />
                           <textarea class="w-100 p-2" name="" id="" rows="3">
                              Đoạn văn chữ thường
                           </textarea>
                           ...
                           <h4 class="mt-5">Thay đổi link gmail tuyển dụng</h4>
