               ...
               <div class="content-body px-0 py-4 px-md-4">
                  <div class="row">
                     <div class="col-12 col-lg-10 col-xl-8 col-xxl-6">
                        ...
                        <br />
                        <textarea class="w-100 p-2" name="" id="" rows="5">
                           Đoạn văn chữ thường
                        </textarea>
                        <br />
                        <label for="">Ảnh công ty</label>
                        <br />
                        <Image
                           class="w-75 my-4"
                           src={ExOfficeImage}
                        ...
                        />
                        <br />
                        <label for="">Đường link google map</label>
                        <br />
                        <textarea
                           class="w-100 p-2"
                           name=""
